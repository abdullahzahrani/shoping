...
<html>
   <head>
       <?php
    include "../Business Layer/log.php"
       ?>
      <meta charset="utf-8" />
   ...
   <body class="sub_page">
      ...
      <section class="product_section layout_padding">
         <div class="container">
            ...
            <main>
               <form method="post" action="log.php" class="input-group">
<h3 style="    margin-left: auto;
    margin-right: auto;">Login page</h3><br><br><br>
                  <input type="text" class="input-field" name="Username" placeholder="User name" required>
                  <input type="password" class="input-field" name="password" placeholder="Password" required>

                  <button type="submit" class="submit-btn"> Login </button> <p>Don't have an account? <a href="reg.php">Register now</a></p>
                  <br><br><br><br>
               </form>
            </main>
